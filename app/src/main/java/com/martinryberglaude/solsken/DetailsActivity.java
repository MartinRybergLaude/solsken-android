...
public class DetailsActivity extends AppCompatActivity {
    ...
    private TextView titleTemperatureText;
    private TextView titleWsymb2Text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTemperatureText = findViewById(R.id.title_temperature);
        titleWsymb2Text = findViewById(R.id.title_wsymb2);
    ...
    private void initWeatherUI() {
        ...
        titleTemperatureText.setText(hourItem.getTemperatureString());
        titleWsymb2Text.setText(hourItem.getWsymb2String());
